...
const fieldIcons = {
  nome: User,
  nomeEmpresa: Building2,
  email: Mail,
} as const;

type DesktopStatus = "idle" | "sending" | "success" | "error";

function InputLabelLine({ children }: { children: ReactNode }) {
  return (
...
function Lines({ children }: { children: ReactNode }) {
  return (
    <div className="flex w-full items-center gap-4">
      ...
      <span className="text-slate-300 font-barlow font-medium whitespace-nowrap text-sm">
        {children}
      </span>
    ...
    <footer className="w-full bg-[#1B263B] py-8 text-[#E0E1DD] overflow-x-hidden">
      <div className="flex flex-col gap-5 items-center">
        ...
        <div className="flex items-center gap-5">
          <Link
            href="https://wa.me/5511961612056?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20a%20Z%C3%AAnite"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-[68px] h-14 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#25D366]"
            aria-label="WhatsApp"
          >
            <Image
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-[68px] h-14 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#E4405F]"
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-[68px] h-14 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#1DA1F2]"
...
function SocialIconsColumn() {
  return (
    ...
    >
      <div className="w-px flex-1 min-h-6 bg-gradient-to-b from-transparent via-slate-500/60 to-transparent" />
      ...
      <div className="flex flex-col gap-4">
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-12 h-12 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#25D366]"
          aria-label="WhatsApp"
        >
          <Image
            src="/icons/whatsapp.svg"
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-12 h-12 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#E4405F]"
          aria-label="Instagram"
        >
          <Image
            src="/icons/instagram.svg"
        ...
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-12 h-12 bg-[#1A2D43] rounded-xl border border-[#3D5A80] transition-all duration-300 hover:scale-110 hover:border-[#1DA1F2]"
          aria-label="X (Twitter)"
        >
          <Image
            src="/icons/x.svg"
      ...
      <div className="w-px flex-1 min-h-6 bg-gradient-to-t from-transparent via-slate-500/60 to-transparent" />
    </motion.div>
  );
}
...
export default function ContatoContent() {
  ...
  // CORREÇÃO PRINCIPAL
  const [desktopStatus, setDesktopStatus] = useState<DesktopStatus>("idle");

  const handleDesktopSubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    <main className="w-full min-h-[90vh] lg:min-h-0 bg-[#1B263B] text-white overflow-x-hidden relative border-t border-[#00B4D8]">
      ...
      <div className="lg:hidden">
        ...
        <section className="w-full max-w-md mx-auto px-6 py-1">
          <form
            ...
            className="w-full bg-[#1B263B] flex flex-col gap-8"
          >
            <div className="flex flex-col gap-1">
      ...
      {/* DESKTOP */}
      <div
        className="hidden lg:flex lg:flex-col relative items-center justify-center overflow-hidden bg-[#0A1628]"
      ...
      >
        ...
        <section className="relative z-10 mx-auto flex w-full max-w-10xl items-center justify-center gap-16 px-12 py-16">
          ...
          <motion.div
            ...
            className="flex flex-1 max-w-sm flex-col gap-5"
          >
            <div className="flex items-center gap-2">
              <span className="h-0.5 w-3 rounded-full bg-[#00B4D8]" />
          ...
          <div className="flex items-stretch gap-6">
            ...
            <motion.form
              ...
              className="w-[44vw] rounded-3xl border border-white/10 bg-[#111C34]/80 backdrop-blur-xl p-8 shadow-2xl flex flex-col gap-6"
            >
